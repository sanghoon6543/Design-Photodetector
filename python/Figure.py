...
class DeviceModelling:
    ...
    def Event_ApplyInfo(self, frame, entryadress, ftstyle='Calibri', ftsize=24, tickftsize=14):
    ...
    def Event_NewFigure(self, inputinfo, ftstyle='Calibri', ftsize=24, tickftsize=20):
